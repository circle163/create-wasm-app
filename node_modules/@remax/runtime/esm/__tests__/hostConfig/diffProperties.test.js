...
describe('diffProperties', function () {
    it('compare props correctly', function () {
        ...
        expect(!!diffProperties({ a: function () { return void 0; } }, { a: function () { return void 0; } })).toBeTruthy();
        ...
        expect(!!diffProperties({ style: { width: 5 }, a: '1', b: null }, { style: { width: 5 }, a: '1', b: undefined })).toBeFalsy();
