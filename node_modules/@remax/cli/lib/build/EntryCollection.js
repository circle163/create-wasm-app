...
class EntryCollection {
    ...
    initEntries() {
        ...
        if ([types_1.BuildType.miniApp, types_1.BuildType.webApp].includes(this.builder.buildType)) {
        ...
        pages.forEach(p => {
            ...
            let entry;
            if (this.builder.target === types_1.Platform.web && ((_a = this.builder.options.web) === null || _a === void 0 ? void 0 : _a.mpa)) {
