...
var FUNCTION_NAME = 'usePageEvent';
exports.pageEvents = new Map();
function getArguments(callExpression, importer) {
    var _a, _b;
    var args = callExpression.node.arguments;
    var eventName = args[0];
    var callback = args[1];
    exports.pageEvents.set(importer, (_b = (_a = exports.pageEvents.get(importer)) === null || _a === void 0 ? void 0 : _a.add(eventName.value)) !== null && _b !== void 0 ? _b : new Set([eventName.value]));
...
function usePageEvent(path, state) {
    ...
    var _a = getArguments(callExpression, importer), eventName = _a[0], callback = _a[1];
