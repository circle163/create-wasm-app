...
.anna-card {
  ...
  .anna-card-horizontal {
    display: flex; }
  .anna-card-shadow {
    box-shadow: 0px 2px 20px 0px #eaecee; }
  .anna-card-cover > img,
  .anna-card-cover span,
  .anna-card-cover image,
  .anna-card-cover text,
  .anna-card-cover audio,
  .anna-card-cover video,
  .anna-card-cover scroll-view,
  .anna-card-cover map {
    display: block;
    width: 100%; }
  .anna-card-head {
...
.anna-input {
  ...
  .anna-input-wrapper {
    ...
    padding: 8px 20px;
    font-size: 28px; }
    .anna-input-wrapper-small {
      padding: 0 12px; }
    .anna-input-wrapper-large {
      padding: 12px 20px; }
    .anna-input-wrapper-small > .anna-input {
      font-size: 24px; }
    .anna-input-wrapper-large > .anna-input {
      height: 50px;
      line-height: 50px;
      font-size: 32px; }
  .anna-input-prefix {
...
.anna-picker-view-column {
  ...
  -webkit-user-select: none;
     -moz-user-select: none;
      -ms-user-select: none;
          user-select: none; }
  .anna-picker-view-column-items {
    transform: translate3d(0, 176px, 0); }
  .anna-picker-view-column-item {
    height: 88px;
    line-height: 88px;
    padding: 0 24px;
    text-align: center; }
...
.anna-picker-view-cancel {
  padding: 0 24px;
  color: #999; }

.anna-picker-view-title {
  color: #333;
  font-weight: 500; }

.anna-picker-view-confirm {
  padding: 0 24px;
  color: #1890ff; }

.anna-picker-view-columns {
  position: relative;
  display: flex;
  height: 440px; }

.anna-picker-view-selected {
  box-sizing: border-box;
  position: absolute;
  left: 0;
  top: 176px;
...
.anna-progress-outer {
  ...
  padding-right: 0;
  margin-right: 0; }
  .anna-progress-show-info .anna-progress-outer {
...
.anna-progress-success-bg, .anna-progress-bg {
  position: relative;
  border-radius: 200px;
  background-color: #1890ff;
  transition: all 0.4s cubic-bezier(0.08, 0.82, 0.17, 1) 0s; }

.anna-progress-success-bg {
  position: absolute;
  left: 0;
  top: 0;
...
.anna-swiper {
  ...
  .anna-swiper-track {
    ...
    cursor: pointer;
    height: 100%; }
    .anna-swiper-track-vertical {
      flex-direction: column; }
  .anna-swiper-item {
    flex-shrink: 0;
    height: 100%;
    width: 100%; }
  .anna-swiper-indicators {
    position: absolute;
    display: flex; }
    .anna-swiper-indicators-bottom {
      bottom: 12px;
      left: 50%;
      transform: translateX(-50%); }
    .anna-swiper-indicators-bottom-left {
      bottom: 16px;
      left: 30px; }
    .anna-swiper-indicators-bottom-right {
      bottom: 16px;
      right: 30px; }
    .anna-swiper-indicators-left {
      flex-direction: column;
      left: 12px;
      top: 50%;
      transform: translateY(-50%); }
    .anna-swiper-indicators-right {
      flex-direction: column;
      right: 12px;
      top: 50%;
      transform: translateY(-50%); }
    .anna-swiper-indicators-outside {
      bottom: -30px;
      left: 50%;
      transform: translateX(-50%); }
  .anna-swiper-indicator {
    height: 12px;
    width: 12px;
    border-radius: 50%;
    background-color: rgba(255, 255, 255, 0.5); }
    .anna-swiper-indicator-active {
      background-color: #feffff; }
    .anna-swiper-indicator-bottom {
      margin-right: 12px; }
    .anna-swiper-indicator-bottom-left {
      margin-right: 12px; }
    .anna-swiper-indicator-bottom-right {
      margin-right: 12px; }
    .anna-swiper-indicator-left {
      margin-bottom: 12px; }
    .anna-swiper-indicator-right {
      margin-bottom: 12px; }
    .anna-swiper-indicator:nth-last-child(1) {
      margin-right: 0;
      margin-bottom: 0; }
...
/*# sourceMappingURL=annar.css.map*/