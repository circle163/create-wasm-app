...
function getRange(format) {
  ...
  var hours = (0, _toConsumableArray2["default"])(new Array(24).keys()).map(function (i) {
    return i < 10 ? '0' + i : String(i);
  });
  var minutes = (0, _toConsumableArray2["default"])(new Array(60).keys()).map(function (i) {
    return i < 10 ? '0' + i : String(i);
  });
...
function getInitValue(format) {
  return (0, _dayjs["default"])().format(format);
}
...
var DatePicker = function DatePicker(props) {
  ...
  var rangeFormat = (0, _react.useMemo)(function () {
  ...
  var handleChange = function handleChange(v) {
    ...
    if (dateArray.length < 5 && rangeFormat.includes('mm')) {
      ...
      var insert = (0, _dayjs["default"])().format('YYYY-MM-DD').split('-').slice(0, filledLength);
      dateArray.unshift.apply(dateArray, (0, _toConsumableArray2["default"])(insert));
    }

    dateArray[1] = dateArray[1] - 1; // @ts-ignore

    var date = (0, _dayjs["default"])((0, _construct2["default"])(Date, (0, _toConsumableArray2["default"])(dateArray))).format(rangeFormat);
