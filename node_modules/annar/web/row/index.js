...
var prefixCls = (0, _common.getPrefixCls)('row');

var renderCols = function renderCols(columns, halfGutter) {
  var cols = _react["default"].Children.map(columns, function (column) {
...
var Row = function Row(props) {
  ...
  var halfGutter = (0, _react.useMemo)(function () {
    return gutter / 2;
  }, [gutter]);
  return /*#__PURE__*/_react["default"].createElement(_web.View, {
    className: (0, _classnames["default"])(prefixCls, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-justify-").concat(justify), justify), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-align-").concat(align), align), _classNames), className),
