...
var getTabContents = function getTabContents(children, activeKey, animated) {
  ...
  React.Children.forEach(children, function (node, index) {
    ...
    if ( /*#__PURE__*/React.isValidElement(node)) {
      ...
      }) && tabContents.push( /*#__PURE__*/React.createElement(TabContent, _extends({
        key: newNode.key
      }, newNode.props, {
...
var Tabs = function Tabs(props) {
  ...
  var TABS_TITLE_ID = useMemo(guid, []);
  ...
  useEffect(function () {
    if (type === 'plain') {
      var query = createSelectorQuery(); // 不加setTimeout的话只能获取部分的nodes(可能是部分 .anna-tabs-plain-title 节点还没来得及渲染出来)
  ...
  var renderTabs = function renderTabs() {
    ...
    if (type === 'plain') {
      ...
      return /*#__PURE__*/React.createElement(View, {
        className: classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-plain"), true), _defineProperty(_classNames, "".concat(prefixCls, "-plain-center"), titleAlign === 'center'), _defineProperty(_classNames, "".concat(prefixCls, "-plain-").concat(TABS_TITLE_ID), true), _classNames))
      }, tabs.map(function (item) {
        var _classNames2;

        return /*#__PURE__*/React.createElement(View, {
          key: item.key,
          className: classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-plain-title"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-plain-center-title"), titleAlign === 'center'), _classNames2)),
    ...
    if (type === 'card') {
      return /*#__PURE__*/React.createElement(View, {
        ...
        return /*#__PURE__*/React.createElement(View, {
          key: item.key,
          className: classNames((_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefixCls, "-card-title"), true), _defineProperty(_classNames3, "".concat(prefixCls, "-card-active"), activeKeyStr === item.key), _classNames3)),
          onTap: function onTap() {
            return handleTabClick(item);
          }
        }, item.tab);
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      className: classNames((_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefixCls, "-slider-bg"), true), _defineProperty(_classNames4, "".concat(prefixCls, "-slider-bg-square"), titleSquare), _classNames4))
    }, /*#__PURE__*/React.createElement(View, {
  ...
  if (direction === 'vertical') {
    return /*#__PURE__*/React.createElement(View, {
      ...
      }, item.tab, selected === index && /*#__PURE__*/React.createElement(View, {
        className: "".concat(prefixCls, "-vertical-sidebar-top")
      }, /*#__PURE__*/React.createElement(View, {
        className: "".concat(prefixCls, "-vertical-sidebar-top-circle")
      })), selected === index && /*#__PURE__*/React.createElement(View, {
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    className: classNames("".concat(prefixCls, "-header"), _defineProperty({}, "".concat(prefixCls, "-header-fixed"), fixed)),
    style: _objectSpread({}, headerStyle)
  }, renderTabs(), /*#__PURE__*/React.createElement(View, {
    className: "".concat(prefixCls, "-header-content")
  }, headerContent)), /*#__PURE__*/React.createElement(View, {
...
var TabContent = function TabContent(props) {
  ...
  if (!active) {
    ...
    return /*#__PURE__*/React.createElement(View, {
      className: classNames("".concat(prefixCls, "-content-tab"), (_classNames6 = {}, _defineProperty(_classNames6, "".concat(prefixCls, "-content-tab-inactive"), !animated), _defineProperty(_classNames6, "".concat(prefixCls, "-content-tab-inactive-animated"), animated), _classNames6)),
      style: style
    }, children);
  }
